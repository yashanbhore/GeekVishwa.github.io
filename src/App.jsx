...
import { replitServices } from '../src/constants'
  ...
  return (
    <main className="relative">
      ...
      <section className="padding">
        ...
        <div className="flex justify-center"><span   className="text-[2rem] goldSponsor ">Gold Sponsers</span></div>
      <section className="padding-x py-10" >
        <Services services={services}/>
      </section>
        <div className="flex justify-center"><span   className="text-[2rem] silverSponsor ">Silver Sponsers</span></div>
      <section className="padding-x py-10">
        <Services services={replitServices}/>
      </section>
      {/* <section className="padding-x py-10">
        <Services services={services}/>
      </section> */}
